            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>Cập nhật <a href="{{ route('student.all')}}"
                        ...
                        <form action="{{ route('student.update', ['id' => $student->id]) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="gioitinh" id="" class="form-control">
                                    <option value="male" {{ $student->gioitinh == 'male' ? 'selected' : '' }}>Nam</option>
                                    <option value="female" {{ $student->gioitinh == 'female' ? 'selected' : '' }}>Nữ
                                    </option>
                                    <option value="other" {{ $student->gioitinh == 'other' ? 'selected' : '' }}>Khác
                                    </option>
                                </select>
                            </div>
                            <div class="form-group mb-3">
